...
import com.emergence.study_app.newTech.retrofit.model.videoPackageOrder.DataItem;
import com.example.study_app.R;

import java.util.List;

public class VideoPackageOrderAdapter extends RecyclerView.Adapter<VideoPackageOrderAdapter.AdapterViewHolder> {
    List<DataItem> modelList;
    Context context;
    String am="";

    public VideoPackageOrderAdapter(List<DataItem> modelList, Context context) {
    ...
    @NonNull
    @Override
    public VideoPackageOrderAdapter.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull VideoPackageOrderAdapter.AdapterViewHolder holder, int position) {
        ...
        holder.layout_subject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("pack_id",modelList.get(position).getPackageId());
                intent.putExtra("name",modelList.get(position).getName());
                intent.putExtra("order_id",modelList.get(position).getOrderId());
                intent.putExtra("date",modelList.get(position).getDate());
